package com.app.runningbuddy.services
...
import com.app.runningbuddy.other.Constants
import com.app.runningbuddy.other.Constants.Companion.ACTION_PAUSE_SERVICE
import com.app.runningbuddy.other.Constants.Companion.ACTION_START_OR_RESUME_SERVICE
import com.app.runningbuddy.other.Constants.Companion.ACTION_STOP_SERVICE
import com.app.runningbuddy.other.Constants.Companion.FASTEST_LOCATION_UPDATE_INTERVAL
import com.app.runningbuddy.other.Constants.Companion.LOCATION_UPDATE_INTERVAL
import com.app.runningbuddy.other.Constants.Companion.NOTIFICATION_CHANNEL_ID
import com.app.runningbuddy.other.Constants.Companion.NOTIFICATION_CHANNEL_NAME
import com.app.runningbuddy.other.Constants.Companion.NOTIFICATION_ID
...
class TrackingService : LifecycleService() {
    ...
    private fun updateNotificationTrackingState(isTracking: Boolean) {
        ...
        val pendingIntent = if (isTracking) {
            ...
            PendingIntent.getService(this, 1, pauseIntent,   FLAG_MUTABLE or FLAG_UPDATE_CURRENT)
        } else {
            val resumeIntent = Intent(this, TrackingService::class.java).apply {
                action = ACTION_START_OR_RESUME_SERVICE
            }
            PendingIntent.getService(this, 2, resumeIntent, FLAG_MUTABLE or  FLAG_UPDATE_CURRENT)
        }
        val notificationManager =
            getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
